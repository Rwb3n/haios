# ANNOTATION_BLOCK_START
{
    ...
    "payload": {
        ...
        "authors_and_contributors": [
            {"g_contribution": 170, "identifier": "Cody"},
            {
                "g_contribution": 221,
                "identifier": "Cody",
        ...
        "internal_dependencies": [".exceptions", "..utils.validators"],
        ...
        "quality_notes": {
            ...
            "unit_tests": {"status": "PENDING_DEFINITION"},
        },
    ...
    def load_and_validate(self) -> Config:
        ...
        try:
            ...
            raise ConfigParseError(
                f"Error parsing JSON from {self._config_path}: {e}"
            ) from e

        logger.debug(
            "Configuration file parsed, now validating against schema '%s'.",
        ...
        try:
            ...
            logger.info(
                "Successfully loaded and validated configuration from %s",
                self._config_path,
            )
            return config
