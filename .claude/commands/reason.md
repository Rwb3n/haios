---
description: Inject Critical Reasoning Framework into context for structured planning
allowed-tools: []
---
# generated: 2025-12-20
# System Auto: last updated on: 2025-12-20 19:53:59
# Critical Reasoning Framework

Invoke this command before complex tasks to enforce structured reasoning.
...
Ensure that all requirements, constraints, options, and preferences are positively incorporated into your plan.
...
- **8.2)** This persistence must be intelligent: In "transparent" errors (e.g. please try again), you *must* retry **unless an explicit retry limit (e.g., max x tries) has been reached**. If such a limit is hit, you *must* stop. On *other* errors, you must change your strategy or arguments, not repeat the same failed call.
...
**Framework Active.** Apply this reasoning structure to all subsequent actions in this session.
