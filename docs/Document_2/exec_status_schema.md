...
*   **Status:** Ratified
*   **Date:** 2025-06-09
*   **ADR References:** ADR-004, ADR-007, ADR-010, ADR-012, ADR-013, ADR-016
*   **Supersedes:** none
...
Each entry is an immutable record (_locked_entry_definition: true).
2.4. tasks_status[]
...
readiness_check: The status of the mandatory pre-execution check for this task.
