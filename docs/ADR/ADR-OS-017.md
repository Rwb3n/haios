# ANNOTATION_BLOCK_START
{
    "artifact_annotation_header": {
        "artifact_id_of_host": "adr_os_017_md",
        "g_annotation_created": 17,
    ...
    "payload": {
        ...
        "authors_and_contributors": [
            { "g_contribution": 17, "identifier": "Hybrid_AI_OS" },
            { "g_contribution": 4, "identifier": "Framework_Compliance_Retrofit" }{ "g_contribution": 4, "identifier": "Framework_Compliance_Retrofit" }
        ],
        "internal_dependencies": [
            "adr_os_template_md",
            "adr_os_032_md""adr_os_032_md"
        ],
        "linked_issue_ids": []
    }
}
