...
*   **Status:** Ratified
*   **Date:** 2025-06-09
*   **ADR References:** ADR-002, ADR-010, ADR-016, ADR-023, ADR-024, ADR-025, ADR-027, ADR-029
*   **Supersedes:** v5.3
    ...
    "tasks": [
      {
        ...
        "authorized_agent_archetypes": ["str"],
        "max_retries": 3,
...
authorized_agent_archetypes (string[]): **(ADR-025)** A list of agent archetypes authorized to execute this task.
