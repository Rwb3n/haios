...
template: work_item
id: E2-109
title: Heartbeat Scheduled Task Environment Fix
status: wontfix
owner: Hephaestus
created: 2025-12-23
closed: 2025-12-25
...
last_updated: '2025-12-27T10:49:07'
---
# WORK-E2-109: Heartbeat Scheduled Task Environment Fix
...
**Problem:** Heartbeat task returns exit code 1 when run by Task Scheduler, but works manually. Root cause: GOOGLE_API_KEY not available in scheduled task context (not loaded from .env). Manual runs work because shell has environment.
---
