...
---
# WORK-E2-139: Insight Crystallization Trigger
...
**Problem:** Agent stores insights when operator prompts "this should be memory" but doesn't autonomously recognize insight-worthy moments. Mid-session discoveries like "oyster-nacre pattern" require operator intervention.
---
