...
**Problem:** HAIOS uses fields like `status`, `lifecycle_phase`, `milestone`, `category` but lacks formal taxonomy. Session 95 identified need to categorize "interrupt" work (E2-130) vs milestone work.
---
