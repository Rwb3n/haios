...
---
# WORK-INV-023: ReasoningBank Feedback Loop Architecture
...
**Problem:** ReasoningBank is write-heavy, read-weak. Memory retrieval works but no feedback loop exists. Agent queries memory, gets results, but: (1) strategies returned are often meta/generic, (2) no mechanism to reinforce "this was useful", (3) learned discounting - agent skims results due to low signal-to-noise.
---
