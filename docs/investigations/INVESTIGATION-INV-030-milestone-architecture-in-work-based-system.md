...
date: 2025-12-24
backlog_id: INV-030
title: "Milestone Architecture in Work-Based System"
author: Hephaestus
session: 112
...
last_updated: 2025-12-24T17:30:38
---
# Investigation: Milestone Architecture in Work-Based System
...
**Trigger:** Session 112 orphan review discovered M8-Memory.md was created in docs/pm/milestones/ without governance - no template, no command, no design.

**Problem Statement:** How should milestones fit into the work-based system (docs/work/) now that docs/pm/ is deprecated?

**Prior Observations:**
- docs/pm/ is deprecated; work files now live in docs/work/
- M8-Memory.md was created ad-hoc in Session 111 during orphan review
- E2-069 (Roadmap and Milestones Structure) defines scope but predates work-based architecture
- INV-029 H5 noted "No canonical milestone registry exists"
- status.py hardcodes milestone names/progress - no dynamic discovery
- Work files have `milestone: M7-Tooling` field but no template validation
...
**Primary Question:** Should milestones be files in docs/work/ (like work items), derived from work file frontmatter, or something else?

**Sub-questions:**
1. Are milestones "work items" or a different entity type?
2. If docs/pm/ is deprecated, where do milestones live?
3. How does status.py discover milestone definitions?
4. What happens to E2-069 scope (predates work-based system)?
...
|---------|------|-------|----------|-------|
| 111 | 2025-12-24 | HYPOTHESIZE | Started | Initial context and hypotheses |
