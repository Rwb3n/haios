...
date: 2025-12-24
backlog_id: INV-031
title: "Directory and Document Hygiene Audit"
author: Hephaestus
session: 112
...
last_updated: 2025-12-24T17:36:55
---
# Investigation: Directory and Document Hygiene Audit
...
**Trigger:** Session 112 orphan review found multiple stale/orphan artifacts - suggesting systemic hygiene issues.

**Problem Statement:** What directories, files, and references are stale, orphaned, or deprecated and need cleanup?

**Prior Observations (Session 112):**
- `.claude/REFS/` had 4 stale HAIOS-specific docs (deleted: OPERATIONS, GOVERNANCE, ARCHITECTURE, CHECKLISTS)
- `docs/pm/` is deprecated but still has `milestones/M8-Memory.md` and `backlog.md`
- INV-025 work file was orphaned (investigation closed but work file still active)
- 17 work items had `milestone: null` (assigned this session)
- CLAUDE.md referenced deleted REFS files

**Suspected Areas (to investigate):**
- `haios_etl/` - deprecated per DEPRECATED.md, may have references
- `docs/pm/` - deprecated, needs migration plan
- `.claude/hooks/archive/` - PowerShell archives, confirm not referenced
- `docs/specs/` - TRDs may be stale
- Root-level deprecated files (deprecated_ADMIN.md, deprecated_AGENT.md, etc.)
