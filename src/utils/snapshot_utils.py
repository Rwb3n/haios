# ANNOTATION_BLOCK_START
{
  ...
  "payload": {
    "authors_and_contributors": [
        ...
        {"g_contribution": 234, "identifier": "Cody", "contribution_summary": "Remediation (exec_plan_00011): Fixed P0 blocking bug by correcting StateManager import to be package-relative."}
    ],
    "internal_dependencies": ["src.core.config", "..state_manager", "src.core.atomic_io"],
    "linked_issue_ids": []
  }
}
    ...
    try:
        ...
        snapshot_data = {
            ...
            "payload": {
                ...
                "key_state_summary": {
                    "os_phase": current_state.get(state_manager.PAYLOAD_KEY, {}).get("st", "UNKNOWN"),
                    "current_plan_id": current_state.get(state_manager.PAYLOAD_KEY, {}).get("cp_id", "NONE"),
                    "open_issues_total": _get_open_issue_count(config)
                }
            }
        }

        redacted_snapshot_data = _redact_snapshot_data(snapshot_data, config.security.redact_regexes)
