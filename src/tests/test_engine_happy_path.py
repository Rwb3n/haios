...
def happy_path_project(tmp_path):
    ...
    config_data = {"paths": {"os_root": str(os_root), "project_workspace": str(workspace)}}
    ...
    plan_data = {
        ...
        "payload": {"tasks": [{
            "task_id": "T1", "type": "CREATE_DIRECTORY", "dependencies": [],
    ...
    status_data = {"plan_id": "exec_plan_001", "payload": {"status": "DRAFT", "tasks_status": []}}
