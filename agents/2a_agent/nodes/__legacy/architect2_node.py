"""
Architect2Node - DEPRECATED Compatibility Wrapper
...
class Architect2Node(AsyncNode):
    ...
    def __init__(self, prompt_file: str = "A2/A2_PROMPT_FILE_BASED.txt"):
        ...
        warnings.warn(
            "Architect2Node is deprecated due to AP-007 anti-pattern. "
    ...
    async def exec_async(self, context: Dict[str, Any]) -> str:
        ...
        return "ERROR: Architect2Node is deprecated. Use ReadPromptNode + UpdateDialogueNode chain."
    
    async def exec_fallback_async(self, prep_res: Dict[str, Any], exc: Exception) -> str:
        """Deprecated fallback method."""
        return "ERROR: Architect2Node is deprecated."
